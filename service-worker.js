...
precacheAndRoute([{'revision':'a75c640e85fd09876cb58d0130f0187f','url':'./index.html'},{'revision':'0744e489de2638bfe936afa0a14eb1a6','url':'main.css'},{'revision':'6cb83b58205be53c209b8b5d74bded08','url':'main.css.map'},{'revision':'86ec60a68e3e7707bb74de025df1ff51','url':'main.js'},{'revision':'e6b30b85bfecef6e3209aca93da60767','url':'main.js.map'},{'revision':'24d084516bf2c7d59f5186352124301c','url':'service-worker.js.map'}] || []);
const matchFunction = _ref => {
  let {
    url
  } = _ref;
  return url.href === 'https://buggy-service-backend.onrender.com/';
};
registerRoute(matchFunction, new StaleWhileRevalidate({
